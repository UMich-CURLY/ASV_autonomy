...
import numpy as np
from transform_math import quaternion_from_euler, quaternion_from_matrix, quaternion_matrix
...
class OdomToPoseTransformer(Node):
    ...
    def odom_callback(self, msg):
        ...
        T_fixed = quaternion_matrix(q_fixed)
        T_fixed[:3, 3] = [
        ...
        # Extract new pose
        new_pos = T_final[:3, 3]
        new_quat = quaternion_from_matrix(T_final)
